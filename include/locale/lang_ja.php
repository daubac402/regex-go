...
class CurrentLanguage
{
	const LANG = [
		...
		,'capture group' => 'グループ化'
		,'backreference to group #1' => '1番目グループを参照する'
		,'non-capturing group' => '結果の中にグループ化しない'
		...
		,'(greedy)' => '（欲張り）'
		,'(lazy)' => '（非欲張り）'
		,'match ab or cd' => '「ab」または「cd」選択する'
		,'RegexGo is a tool to learn, build, & test Regular Expressions (by Javascript)' => 'RegexGoは正規表現を学習、構築、テストすることができる。'
		,'Results update in <b>real-time</b> as you type' => '入力時に<b>リアルタイム</b>で結果を更する。'
		,'<b>Roll over</b> a match or expression for details' => '詳細するのために正規表現の文字を<b>ホバー</b>する。'
